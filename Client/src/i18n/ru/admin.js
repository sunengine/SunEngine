export default {
	...
	ConfigurationAdmin: {
		...
		items: {
			...
			"Register:ConfirmText":  "Подтверждение согласия при регистрации",
			"Register:RequireUniqueEmail": "Email не может повторяться",
			"Register:AllowedUserNameCharacters": "Допустимые символы в имени",
			"PasswordValidation:RequireDigit": "Необходимо число",
			"PasswordValidation:RequireLowercase": "Необходима строчная буква",
			"PasswordValidation:RequireNonAlphanumeric": "Необходим не буквенный и не числовой символ",
			"PasswordValidation:RequireUppercase": "Необходима заглавная буква",
			"PasswordValidation:RequiredUniqueChars": "Количество уникальных символов",
			"PasswordValidation:RequiredLength":  "Минимальное число символов",
			...
			"Sanitizer:SanitizeAdminMaterials" : "Санитаризировать материалы написанные админом",
		...
		tooltips: {
			...
			"Global:RegisterConfirmText":  "Этот текст показывается пользователю при регистрации. Пользователь должен принять соглашение для того что бы пройти регистрацию. В тексте можно использовать ссылки на страницу соглашения.",
