export default {
  ...
  ConfigurationAdmin: {
    ...
    items: {
      ...
      'Images:AvatarSizePixels': 'Размер аватары в пикселях',
      'Images:ImageRequestSizeLimitBytes': 'Максимальный размер изображения в байтах',
      'Images:MaxImageHeight': 'Высота изображения после сжатия px',
      'Images:MaxImageWidth': 'Ширина изображения после сжатия px',
