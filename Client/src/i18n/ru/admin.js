	...
	ConfigurationAdmin: {
		...
		items: {
			...
			"PasswordValidation:RequireNonAlphanumeric":
				"Необходим не буквенный и не числовой символ",
			...
			"Sanitizer:SanitizeAdminMaterials":
				"Санитаризировать материалы написанные админом",
		...
		tooltips: {
            ...
            "Global:layoutOptions": "Расположение основных панелей. Варианты по ссылке.",
