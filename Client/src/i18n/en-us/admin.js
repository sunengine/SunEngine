export default {
  ...
  ConfigurationAdmin: {
    ...
    items: {
      ...
      'Global:SiteSubTitle': '',
      'Dev:ShowExceptions': '',
      'Images:AllowGifUpload': '',
      'Images:AllowSvgUpload': '',
      'Images:AvatarSizePixels': '',
      ...
      'Images:ResizeMaxHeightPixels': '',
      'Images:ResizeMaxWidthPixels': '',
      'Sanitizer:AllowedAttributes': '',
      'Sanitizer:AllowedClasses': '',
      'Sanitizer:AllowedCssProperties': '',
      'Sanitizer:AllowedImageDomains': '',
      ...
      'Blog:PostsPageSize': '',
      'Blog:PreviewLength': '',
      'Articles:CategoryPageSize': '',
      'Forum:NewTopicsMaxPages': '',
      'Forum:NewTopicsPageSize': '',
      'Jwe:Issuer': '',
      'Jwe:LongTokenLiveTimeDays': '',
      'Jwe:ShortTokenLiveTimeMinutes': '',
      'FileLoading:MaxArchiveSize': '',
      'FileLoading:MaxExtractArchiveSize': '',
      'Skins:CurrentSkinName': '',
