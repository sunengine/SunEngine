<template>
  <q-page class="create-material q-pa-md">
    ...
    <div class="create-material__btn-block q-mt-md">
      <q-btn icon="fas fa-arrow-circle-right" class="create-material__send-btn send-btn" no-caps :loading="loading"
             :label="$tl('sendBtn')"
             @click="send" color="send">
        <LoaderSent slot="loading"/>
      </q-btn>
      <q-btn no-caps icon="fas fa-times" class="create-material_cancel-btn cancel-btn q-ml-sm" @click="$router.back()"
