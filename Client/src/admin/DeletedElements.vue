<template>
    <q-page class="deleted-elements page-padding">
        ...
        <q-checkbox class="deleted-elements__show-deleted" :toggle-indeterminate="false"
        ...
        <q-btn color="primary" no-caps icon="fas fa-trash" :label="$tl('btnDeleteAllMarkedComments')" :loading="loading"
