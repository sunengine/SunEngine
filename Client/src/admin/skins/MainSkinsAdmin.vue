    ...
    <div class="skins-admin">
        ...
        <div class="flex flex-center">
            <q-btn no-caps icon="fas fa-cloud-upload-alt" @click="showUploadDialog"
                   class="skins-admin__post-btn post-btn q-mb-lg" :loading="loading" :label="$tl('upload')">
            ...
            <q-card :key="skin.name" class="skins-admin__card" v-for="skin in skins">
                ...
                <q-card-actions align="around">
                    ...
                    <q-btn class="skins-admin__delete-btn" no-caps @click="showSkinInfo(skin)" flat
                           icon="fas fa-info"/>
                    <q-btn v-if="!skin.current" class="skins-admin__info-btn" no-caps @click="deleteSkin(skin.name)"
                           flat
