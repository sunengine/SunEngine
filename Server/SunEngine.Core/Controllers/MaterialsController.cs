...
namespace SunEngine.Core.Controllers
{
  ...
  public class MaterialsController : BaseController
  {
    ...
    [HttpPost]
    public virtual async Task<IActionResult> GetMaterialsFromSection(string sectionName, string sortType = null,
      int page = 1, bool showDeleted = false)
    {
      var section = (CategoryServerSectionData) sectionsCache.GetSectionserverCached(sectionName, User.Roles).Data;
