...
namespace SunEngine.Infrastructure
{
    public class SpamProtectionFilter : ActionFilterAttribute
    {
        ...
        string MakeKey(int userId, string controllerName, string actionName)
        {
            return RequestFree.CacheKeyStart + "-" + userId + "-" + controllerName + "-" + actionName;
        }
        ...
        public override void OnResultExecuted(ResultExecutedContext context)
        {
            ...
            {
                var requestFree = new RequestFree(controller.User.UserId, timeout);
    ...
    {
        public const string CacheKeyStart = "RF";

        private int userId;
        private DateTime dateTimeTil;

        public RequestFree(int userId, TimeSpan timeout)
        {
            this.userId = userId;
