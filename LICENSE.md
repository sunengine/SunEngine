...
#### Изменения лицензии:
8. Старые версии SunEngine остаются под той лицензией под которой они были выпущены.
9. В новых версиях SunEngine допускается изменение лицензии со стороны автора SunEngine (Дмитрия Полянина), без уведомления пользователей.
